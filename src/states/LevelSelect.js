...
class LevelSelect extends Phaser.State {
	...
	create() {
		...
		this.lvlButtons[3] = new MenuButton(this.game, this.game.width/2-110, this.lvlButtons[1].position.y+this.lvlButtons[1].height+40, "Level 3", this.startLvl3);
		this.lvlButtons[4] = new MenuButton(this.game, this.game.width/2+110, this.lvlButtons[1].position.y+this.lvlButtons[1].height+40, "Level 4", this.startLvl4);
		this.lvlButtons[5] = new MenuButton(this.game, this.game.width/2, this.lvlButtons[3].position.y+this.lvlButtons[3].height+40, "Level 5", this.startLvl5);
